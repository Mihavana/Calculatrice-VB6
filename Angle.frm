...
l = 0
End If
If listVol(j) = "Degré(s)" Then
   If listVol(l) = "Degré(s)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Radians" Then
    panConversion(l) = panConversion(j) * 0.017453
   ElseIf listVol(l) = "Grades" Then
    panConversion(l) = panConversion(j) * 1.111111
   End If
ElseIf listVol(j) = "Radians" Then
   If listVol(l) = "Radians" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Degré(s)" Then
    panConversion(l) = panConversion(j) * 57.29578
   ElseIf listVol(l) = "Grades" Then
    panConversion(l) = panConversion(j) * 63.66198
   End If
ElseIf listVol(j) = "Grades" Then
   If listVol(l) = "Grades" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Degré(s)" Then
    panConversion(l) = panConversion(j) * 0.9
   ElseIf listVol(l) = "Radians" Then
    panConversion(l) = panConversion(j) * 0.015708
   End If
End If
End Function
