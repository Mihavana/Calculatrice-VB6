...
Begin VB.Form Données 
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Données.frx":3F07
      Left            =   120
      List            =   "Données.frx":3F1D
      TabIndex        =   1
      Top             =   3120
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Données.frx":3F5B
      Left            =   120
      List            =   "Données.frx":3F71
      TabIndex        =   0
      Top             =   6000
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Bits" Then
   If listVol(l) = "Bits" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Octets" Then
    panConversion(l) = panConversion(j) * 0.125
   ElseIf listVol(l) = "Mégabits" Then
    panConversion(l) = panConversion(j) * 0.000001
   ElseIf listVol(l) = "Mégaoctets" Then
    panConversion(l) = panConversion(j) * 0.000000125
   ElseIf listVol(l) = "Gigabits" Then
    panConversion(l) = panConversion(j) * 0.000000001
   ElseIf listVol(l) = "Gigaoctets" Then
    panConversion(l) = panConversion(j) * 0.000000000125
   End If
ElseIf listVol(j) = "Octets" Then
   If listVol(l) = "Octets" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Bits" Then
    panConversion(l) = panConversion(j) * 8
   ElseIf listVol(l) = "Mégabits" Then
    panConversion(l) = panConversion(j) * 0.000008
   ElseIf listVol(l) = "Mégaoctets" Then
    panConversion(l) = panConversion(j) * 0.000001
   ElseIf listVol(l) = "Gigabits" Then
    panConversion(l) = panConversion(j) * 0.000000008
   ElseIf listVol(l) = "Gigaoctets" Then
    panConversion(l) = panConversion(j) * 0.000000001
   End If
ElseIf listVol(j) = "Mégabits" Then
   If listVol(l) = "Mégabits" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Bits" Then
    panConversion(l) = panConversion(j) * 1000000
   ElseIf listVol(l) = "Octets" Then
    panConversion(l) = panConversion(j) * 125000
   ElseIf listVol(l) = "Mégaoctets" Then
    panConversion(l) = panConversion(j) * 0.125
   ElseIf listVol(l) = "Gigabits" Then
    panConversion(l) = panConversion(j) * 0.001
   ElseIf listVol(l) = "Gigaoctets" Then
    panConversion(l) = panConversion(j) * 0.000125
   End If
ElseIf listVol(j) = "Mégaoctets" Then
   If listVol(l) = "Mégaoctets" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Bits" Then
    panConversion(l) = panConversion(j) * 8000000
   ElseIf listVol(l) = "Octets" Then
    panConversion(l) = panConversion(j) * 1000000
   ElseIf listVol(l) = "Mégabits" Then
    panConversion(l) = panConversion(j) * 8
   ElseIf listVol(l) = "Gigabits" Then
    panConversion(l) = panConversion(j) * 0.008
   ElseIf listVol(l) = "Gigaoctets" Then
    panConversion(l) = panConversion(j) * 0.001
  End If
ElseIf listVol(j) = "Gigabits" Then
   If listVol(l) = "Gigabits" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Bits" Then
    panConversion(l) = panConversion(j) * 1000000000
   ElseIf listVol(l) = "Octets" Then
    panConversion(l) = panConversion(j) * 125000000
   ElseIf listVol(l) = "Mégabits" Then
    panConversion(l) = panConversion(j) * 1000
   ElseIf listVol(l) = "Mégaoctets" Then
    panConversion(l) = panConversion(j) * 125
   ElseIf listVol(l) = "Gigaoctets" Then
    panConversion(l) = panConversion(j) * 0.125
   End If
ElseIf listVol(j) = "Gigaoctets" Then
   If listVol(l) = "Gigaoctets" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Bits" Then
    panConversion(l) = panConversion(j) * 8000000000#
   ElseIf listVol(l) = "Octets" Then
    panConversion(l) = panConversion(j) * 1000000000
   ElseIf listVol(l) = "Mégabits" Then
    panConversion(l) = panConversion(j) * 8000
   ElseIf listVol(l) = "Mégaoctets" Then
    panConversion(l) = panConversion(j) * 1000
   ElseIf listVol(l) = "Gigabits" Then
    panConversion(l) = panConversion(j) * 8
