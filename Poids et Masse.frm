...
Begin VB.Form PoidsMasse 
   ...
   Begin VB.Frame FrameSupport 
      ...
      Begin VB.Frame FrameMenu 
         ...
         Begin VB.Image Logos 
            ...
            Index           =   15
            Left            =   0
            Picture         =   "Poids et Masse.frx":0000
            Stretch         =   -1  'True
            Top             =   10320
            Width           =   375
         End
         Begin VB.Image Logos 
            ...
            Index           =   14
            Left            =   0
            Picture         =   "Poids et Masse.frx":03D6
            Top             =   9600
            Width           =   480
         End
         Begin VB.Image Logos 
            ...
            Index           =   13
            Left            =   0
            Picture         =   "Poids et Masse.frx":07C6
            Top             =   9000
            Width           =   465
         End
         Begin VB.Image Logos 
            ...
            Index           =   12
            Left            =   0
            Picture         =   "Poids et Masse.frx":0B91
            Top             =   7680
            Width           =   465
         End
         Begin VB.Image Logos 
            ...
            Index           =   11
            Left            =   0
            Picture         =   "Poids et Masse.frx":0FC5
            Top             =   7080
            Width           =   405
         End
         Begin VB.Image Logos 
            ...
            Index           =   10
            Left            =   0
            Picture         =   "Poids et Masse.frx":139D
            Top             =   8280
            Width           =   405
         End
         Begin VB.Image Logos 
            ...
            Index           =   9
            Left            =   0
            Picture         =   "Poids et Masse.frx":1788
            Top             =   6480
            Width           =   465
         End
         Begin VB.Image Logos 
            ...
            Index           =   8
            Left            =   0
            Picture         =   "Poids et Masse.frx":1B2B
            Top             =   5880
            Width           =   480
         End
         Begin VB.Image Logos 
            ...
            Index           =   7
            Left            =   80
            Picture         =   "Poids et Masse.frx":1F11
            Top             =   4800
            Width           =   330
         End
         Begin VB.Image Logos 
            ...
            Index           =   6
            Left            =   0
            Picture         =   "Poids et Masse.frx":22FF
            Stretch         =   -1  'True
            Top             =   5280
            Width           =   450
         End
         Begin VB.Image Logos 
            ...
            Index           =   5
            Left            =   120
            Picture         =   "Poids et Masse.frx":26A2
            Top             =   4080
            Width           =   300
         End
         Begin VB.Image Logos 
            ...
            Index           =   4
            Left            =   50
            Picture         =   "Poids et Masse.frx":2A5C
            Top             =   3480
            Width           =   405
         End
         Begin VB.Label surf 
         ...
         Begin VB.Image Logos 
            ...
            Index           =   3
            Left            =   120
            Picture         =   "Poids et Masse.frx":2EBF
            Top             =   2280
            Width           =   420
         End
         ...
         Begin VB.Image Logos 
            ...
            Index           =   0
            Left            =   120
            Picture         =   "Poids et Masse.frx":32E8
            Top             =   480
            Width           =   390
         End
         Begin VB.Image Logos 
            ...
            Index           =   1
            Left            =   120
            Picture         =   "Poids et Masse.frx":372B
            Top             =   1080
            Width           =   375
         End
         Begin VB.Image Logos 
            ...
            Index           =   2
            Left            =   0
            Picture         =   "Poids et Masse.frx":3AF7
            Top             =   1680
            Width           =   555
         End
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Poids et Masse.frx":3F07
      Left            =   120
      List            =   "Poids et Masse.frx":3F17
      TabIndex        =   1
      Top             =   3120
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Poids et Masse.frx":3F53
      Left            =   120
      List            =   "Poids et Masse.frx":3F63
      TabIndex        =   0
      Top             =   6000
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Carat(s)" Then
   If listVol(l) = "Carat(s)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Grammes" Then
    panConversion(l) = panConversion(j) * 0.2
   ElseIf listVol(l) = "Kilogramme(s)" Then
    panConversion(l) = panConversion(j) * 0.0002
   ElseIf listVol(l) = "Tonne(s) métrique(s)" Then
    panConversion(l) = panConversion(j) * 0.0000002
   End If
ElseIf listVol(j) = "Grammes" Then
   If listVol(l) = "Grammes" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Carat(s)" Then
    panConversion(l) = panConversion(j) * 5
   ElseIf listVol(l) = "Kilogramme(s)" Then
    panConversion(l) = panConversion(j) * 0.001
   ElseIf listVol(l) = "Tonne(s) métrique(s)" Then
    panConversion(l) = panConversion(j) * 0.000001
   End If
ElseIf listVol(j) = "Kilogramme(s)" Then
   If listVol(l) = "Kilogramme(s)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Carat(s)" Then
    panConversion(l) = panConversion(j) * 5000
   ElseIf listVol(l) = "Grammes" Then
    panConversion(l) = panConversion(j) * 1000
   ElseIf listVol(l) = "Tonne(s) métrique(s)" Then
    panConversion(l) = panConversion(j) * 0.001
   End If
ElseIf listVol(j) = "Tonne(s) métrique(s)" Then
   If listVol(l) = "Tonne(s) métrique(s)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Carat(s)" Then
    panConversion(l) = panConversion(j) * 5000000
   ElseIf listVol(l) = "Grammes" Then
