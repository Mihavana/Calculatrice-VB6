...
Begin VB.Form Pression 
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Pression.frx":3F07
      Left            =   360
      List            =   "Pression.frx":3F17
      TabIndex        =   1
      Top             =   3000
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Pression.frx":3F44
      Left            =   240
      List            =   "Pression.frx":3F54
      TabIndex        =   0
      Top             =   5880
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Atmosphères" Then
   If listVol(l) = "Atmosphères" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Bars" Then
    panConversion(l) = panConversion(j) * 1.01325
   ElseIf listVol(l) = "Kilopascals" Then
    panConversion(l) = panConversion(j) * 101.325
   ElseIf listVol(l) = "Pascals" Then
    panConversion(l) = panConversion(j) * 101325
   End If
ElseIf listVol(j) = "Bars" Then
   If listVol(l) = "Bars" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Atmosphères" Then
    panConversion(l) = panConversion(j) * 0.986923
   ElseIf listVol(l) = "Kilopascals" Then
    panConversion(l) = panConversion(j) * 100
   ElseIf listVol(l) = "Pascals" Then
    panConversion(l) = panConversion(j) * 100000
   End If
ElseIf listVol(j) = "Kilopascals" Then
   If listVol(l) = "Kilopascals" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Atmosphères" Then
    panConversion(l) = panConversion(j) * 0.009869
   ElseIf listVol(l) = "Bars" Then
    panConversion(l) = panConversion(j) * 0.01
   ElseIf listVol(l) = "Pascals" Then
    panConversion(l) = panConversion(j) * 1000
   End If
ElseIf listVol(j) = "Pascals" Then
   If listVol(l) = "Pascals" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Atmospères" Then
