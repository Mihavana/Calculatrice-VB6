...
Begin VB.Form Surface 
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Surface.frx":3F07
      Left            =   120
      List            =   "Surface.frx":3F17
      TabIndex        =   14
      Top             =   6000
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Surface.frx":3F61
      Left            =   120
      List            =   "Surface.frx":3F71
      TabIndex        =   13
      Top             =   3120
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Centimètre(s) carré(s)" Then
   If listVol(l) = "Centimètre(s) carré(s)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Mètres carrés" Then
    panConversion(l) = panConversion(j) * 0.0001
   ElseIf listVol(l) = "Hectare(s)" Then
    panConversion(l) = panConversion(j) * 0.00000001
   ElseIf listVol(l) = "Kilomètres carrés" Then
    panConversion(l) = panConversion(j) * 0.0000000001
   End If
ElseIf listVol(j) = "Mètres carrés" Then
   If listVol(l) = "Mètres carrés" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Centimètre(s) carré(s)" Then
   ...
   End If
ElseIf listVol(j) = "Hectare(s)" Then
   If listVol(l) = "Hectare(s))" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Mètres carrés" Then
    panConversion(l) = panConversion(j) * 10000
   ElseIf listVol(l) = "Centimètre(s) carré(s)" Then
    panConversion(l) = panConversion(j) * 100000000
   ElseIf listVol(l) = "Kilomètres carrés" Then
    panConversion(l) = panConversion(j) * 0.01
   End If
ElseIf listVol(j) = "Kilomètres carrés" Then
   If listVol(l) = "Kilomètres carrés" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Hectare(s)" Then
   ...
   ElseIf listVol(l) = "Centimètre(s) carré(s)" Then
    panConversion(l) = panConversion(j) * 10000000000#
   End If
End If
End Function
