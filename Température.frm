...
Begin VB.Form Temp 
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Température.frx":3F07
      Left            =   0
      List            =   "Température.frx":3F14
      TabIndex        =   1
      Top             =   3120
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Température.frx":3F35
      Left            =   0
      List            =   "Température.frx":3F42
      TabIndex        =   0
      Top             =   6000
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Celsius" Then
   If listVol(l) = "Fahrenheit" Then
    panConversion(l) = (panConversion(j) * (9 / 5)) + 32
   ElseIf listVol(l) = "Kelvin" Then
    panConversion(l) = panConversion(j) + 273.15
   End If
ElseIf listVol(j) = "Fahrenheit" Then
   If listVol(l) = "Celsius" Then
    panConversion(l) = (panConversion(j) - 32) * 5 / 9
   ElseIf listVol(l) = "Kelvin" Then
    panConversion(l) = (panConversion(j) - 32) * (5 / 9) + 273.15
   End If
ElseIf listVol(j) = "Kelvin" Then
   If listVol(l) = "Celsius" Then
    panConversion(l) = panConversion(j) - 273.15
   ElseIf listVol(l) = "Fahrenheit" Then
    panConversion(l) = (panConversion(j) - 273.15) * (5 / 9) + 32
   End If
End If
End Function
