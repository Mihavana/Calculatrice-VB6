...
Begin VB.Form Vitesse 
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Vitesse.frx":3F07
      Left            =   120
      List            =   "Vitesse.frx":3F1A
      TabIndex        =   1
      Top             =   3000
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Vitesse.frx":3F71
      Left            =   120
      List            =   "Vitesse.frx":3F84
      TabIndex        =   0
      Top             =   5880
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Centimètre(s) par seconde" Then
   If listVol(l) = "Centimètre(s) par seconde" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Mètres par seconde" Then
    panConversion(l) = panConversion(j) * 0.01
   ElseIf listVol(l) = "Kilomètres par heure" Then
    panConversion(l) = panConversion(j) * 0.036
   ElseIf listVol(l) = "Noeuds" Then
    panConversion(l) = panConversion(j) * 0.01944
   ElseIf listVol(l) = "Mach" Then
    panConversion(l) = panConversion(j) * 0.000029
   End If
ElseIf listVol(j) = "Mètres par seconde" Then
   If listVol(l) = "Mètres par seconde" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Centimètre(s) par seconde" Then
    panConversion(l) = panConversion(j) * 100
   ElseIf listVol(l) = "Kilomètres par heure" Then
    panConversion(l) = panConversion(j) * 3.6
   ElseIf listVol(l) = "Noeuds" Then
    panConversion(l) = panConversion(j) * 1.944012
   ElseIf listVol(l) = "Mach" Then
    panConversion(l) = panConversion(j) * 0.002939
   End If
ElseIf listVol(j) = "Kilomètres par heure" Then
   If listVol(l) = "Kilomètres par heure" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Centimètre(s) par seconde" Then
    panConversion(l) = panConversion(j) * 27.77778
   ElseIf listVol(l) = "Mètres par seconde" Then
    panConversion(l) = panConversion(j) * 0.277778
   ElseIf listVol(l) = "Noeuds" Then
    panConversion(l) = panConversion(j) * 0.540003
   ElseIf listVol(l) = "Mach" Then
    panConversion(l) = panConversion(j) * 0.000816
   End If
ElseIf listVol(j) = "Noeuds" Then
   If listVol(l) = "Noeuds" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Centimètre(s) par seconde" Then
    panConversion(l) = panConversion(j) * 51.44
   ElseIf listVol(l) = "Mètres par seconde" Then
    panConversion(l) = panConversion(j) * 0.5144
   ElseIf listVol(l) = "Kilomètres par heure" Then
    panConversion(l) = panConversion(j) * 1.85184
   ElseIf listVol(l) = "Mach" Then
    panConversion(l) = panConversion(j) * 0.001512
   End If
ElseIf listVol(j) = "Mach" Then
   If listVol(l) = "Mach" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Centimètre(s) par seconde" Then
    panConversion(l) = panConversion(j) * 34030
   ElseIf listVol(l) = "Mètres par seconde" Then
    panConversion(l) = panConversion(j) * 340.3
   ElseIf listVol(l) = "Kilomètres par heure" Then
    panConversion(l) = panConversion(j) * 1225.08
   ElseIf listVol(l) = "v" Then
    panConversion(l) = panConversion(j) * 661.5474
   End If
End If
End Function
