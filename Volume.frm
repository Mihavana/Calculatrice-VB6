...
Begin VB.Form Vol 
   ...
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "Volume.frx":3F07
      Left            =   120
      List            =   "Volume.frx":3F1D
      TabIndex        =   14
      Top             =   6000
      Width           =   3135
   End
   Begin VB.ComboBox listVol 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "Volume.frx":3F8F
      Left            =   120
      List            =   "Volume.frx":3FA5
      TabIndex        =   13
      Top             =   3120
      Width           =   3135
   End
...
l = 0
End If
If listVol(j) = "Millilitres" Then
   If listVol(l) = "Centimètre(s) cube(s)" Or listVol(l) = "Millilitres" Then
    panConversion(l) = panConversion(j) * 1
   ElseIf listVol(l) = "L" Then
    panConversion(l) = panConversion(j) * 0.001
   ElseIf listVol(l) = "Mètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 0.000001
   ElseIf listVol(l) = "Cuillère(s) à café(E-U.)" Then
    panConversion(l) = panConversion(j) * 0.202884
   ElseIf listVol(l) = "Cuillère(s) à soupe(E-U.)" Then
    panConversion(l) = panConversion(j) * 0.067628
   End If
ElseIf listVol(j) = "Centimètre(s) cube(s)" Then
   If listVol(l) = "Centimètre(s) cube(s)" Or listVol(l) = "Millilitres" Then
    panConversion(l) = panConversion(j) * 1
   ElseIf listVol(l) = "L" Then
    panConversion(l) = panConversion(j) * 0.001
   ...
   ElseIf listVol(l) = "Cuillère(s) à soupe(E-U.)" Then
    panConversion(l) = panConversion(j) * 0.067628
   End If
ElseIf listVol(j) = "L" Then
   If listVol(l) = "L" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Millilitres" Or listVol(l) = "Centimètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 1000
   ElseIf listVol(l) = "Mètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 0.001
   ElseIf listVol(l) = "Cuillère(s) à café(E-U.)" Then
    panConversion(l) = panConversion(j) * 202.8841
   ElseIf listVol(l) = "Cuillère(s) à soupe(E-U.)" Then
    panConversion(l) = panConversion(j) * 67.62805
   End If
ElseIf listVol(j) = "Mètre(s) cube(s)" Then
   If listVol(l) = "Mètre(s) cube(s)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Millilitres" Or listVol(l) = "Centimètre(s) cube(s)" Then
   ...
   ElseIf listVol(l) = "L" Then
    panConversion(l) = panConversion(j) * 1000
   ElseIf listVol(l) = "Cuillère(s) à café(E-U.)" Then
    panConversion(l) = panConversion(j) * 202884.1
   ElseIf listVol(l) = "Cuillère(s) à soupe(E-U.)" Then
    panConversion(l) = panConversion(j) * 67628.05
  End If
ElseIf listVol(j) = "Cuillère(s) à café(E-U.)" Then
   If listVol(l) = "Cuillère(s) à café(E-U.)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Millilitres" Or listVol(l) = "Centimètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 4.928922
   ElseIf listVol(l) = "L" Then
    panConversion(l) = panConversion(j) * 0.004929
   ElseIf listVol(l) = "Mètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 0.000005
   ElseIf listVol(l) = "Cuillère(s) à soupe(E-U.)" Then
    panConversion(l) = panConversion(j) * 0.333333
   End If
ElseIf listVol(j) = "Cuillère(s) à soupe(E-U.)" Then
   If listVol(l) = "Cuillère(s) à soupe(E-U.)" Then
    panConversion(l) = panConversion(j)
   ElseIf listVol(l) = "Millilitres" Or listVol(l) = "Centimètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 14.78676
   ElseIf listVol(l) = "L" Then
    panConversion(l) = panConversion(j) * 0.014787
   ElseIf listVol(l) = "Mètre(s) cube(s)" Then
    panConversion(l) = panConversion(j) * 0.000015
   ElseIf listVol(l) = "Cuillère(s) à café(E-U.)" Then
    panConversion(l) = panConversion(j) * 3
   End If
End If
End Function
